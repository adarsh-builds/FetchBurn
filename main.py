...
confirm = input(f"Do you want to write or restore: (write/restore): ")
if confirm.lower() == 'write':
            ...
            if confirm.lower() == 'yes':
                try:
                    ...
                    if write_iso_with_python(save_path, device_path):
                        ...
                        # Note: Written drive will appear as RAW in Windows. 
                        # This is normal. The drive is fully bootable on target machine.
                    else:
